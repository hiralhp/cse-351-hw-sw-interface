...
// I chose to cast to a long for all my casts because when I cast to an int I get the following error:
// cast from pointer to integer of different size [-Wpointer-to-int-cast]

/*gets index of wear int is stored and where is ends and then subtracts*/
int intSize() {
  int intArray[10];
  int * intPtr1;
  int * intPtr2;
  // Write code to compute size of an integer.
  int addr1 = (long)intArray;
  int addr2 = (long)(intArray + 1);
  return addr2 - addr1;
}
 ...
 */
//size of double is 8
/*gets index of wear double is stored and where is ends and then subtracts*/
int doubleSize() {
  double doubArray[10];
  double * doubPtr1;
  double * doubPtr2;
  // Write code to compute size of a double.
  int addr1 = (long)doubArray;
  int addr2 = (long)(doubArray + 1);
  return addr2 - addr1;
}
 ...
 */
/*gets index of wear pointer is stored and where is ends and then subtracts*/
int pointerSize() {
  double * ptrArray[10];
  double ** ptrPtr1;
  double ** ptrPtr2;
  // Write code to compute size of a pointer.
  int addr1 = (long)ptrArray;
  int addr2 = (long)(ptrArray + 1);
  return addr2 - addr1;
}
...
int changeValue() {
  ...
  //ptr 2 points at ptr 1 which is pointing at array. ptr 2 specifically points at index 5
  // returns value at index 5
 ...
 */
/* checks if both addr1 and addr2 are equal using mask*/
 ...
 * Operators / and % and loops are NOT allowed.
 */
/*checks if the ptr element is stored within the array*/
